...
public class jbdcUtil_CompositeQuery_FAQContent {

	public static String get_aCondition_For_myDB(String columnName, String value) {

		String aCondition = null;
		
		if ("faq_Content".equals(columnName) || "fqKeyWord".equals(columnName)) // �Ω�varchar
	...
	public static void main(String argv[]) {
		...
		map.put("faqContent", new String[] { "7001" });
