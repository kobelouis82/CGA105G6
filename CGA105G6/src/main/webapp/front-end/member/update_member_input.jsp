                    ...
                    <div class="col-lg-8">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">會員資料修改</h1>
                            </div>
                    			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/MemServletFront" name="form1" enctype="multipart/form-data">
                        	<div id='preview' style="width=200px"></div>
				 	 		<div class='img'></div>
                        		<input class="form-control" type="hidden" name="memAccount"
								size="45" value="<%=memVO.getMemAccount()%>" />
                  	...
                  	<div class="row">
                    		...
                    		<div class="col-lg-12" >                             
                                    <form METHOD="get"
										ACTION="<%=request.getContextPath()%>/front-end/product/index.jsp">
...
//             alert("123");
            ...
            //建立好Get連接與送出請求
// let memAccount = document.getElementById("memAccount").value;
            xhr.send(null);
        }
    })
