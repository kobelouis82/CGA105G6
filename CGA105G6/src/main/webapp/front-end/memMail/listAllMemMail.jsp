...
<div class="container">
	<div class="row">
		<div class="right col">
			...
			<a class="content" href="<%=request.getContextPath()%>/front-end/memMail/listAllMemMailSend.jsp">寄件備份列表</a>
			</h3>
			<hr>
			
				<div style="text-align:center;font-weight:555;">
					<div style="width: 100px;display:inline-block;">寄件人</div>
					<div style="width: 150px;display:inline-block;">標題</div>
					<div style="width: 250px;display:inline-block;">信件內容</div>
					<div style="width: 100px;display:inline-block;">信件日期</div>
				</div>
