							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">您的帳號尚未驗證成功，請重新驗證以使用完整功能：</h1>
									</div>
									<br>
									<div class="text-center">
										<a class="btn"
											href="<%=request.getContextPath()%>/memServlet1.do?action=resend&memMail=<%=memMail%>&memName=<%=memName%>">重發驗證信</a>
									</div>
									<div class="text-center">
										<a class="btn"
											href="<%=request.getContextPath()%>/memServlet1.do?action=logout">登出並返回首頁</a>
									</div>
								</div>
							</div>
							<div class="col-lg-3 d-none d-lg-block "></div>
