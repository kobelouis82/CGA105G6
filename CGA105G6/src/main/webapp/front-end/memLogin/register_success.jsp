				...
				<div class="card o-hidden border-0 shadow-lg my-5">
							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">驗證信已發送</h1>
										<h1 class="h4 text-gray-900 mb-4">請至信箱查收驗證碼：</h1>
									</div>
									<br>
                   ...
                   <form method="post" action="<%=request.getContextPath()%>/memServlet1.do">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/memServlet1.do">
 					...
 					<a class="btn btn-light" href="<%=request.getContextPath()%>/memServlet1.do?action=logout" style="text-decoration: none;">取消登入</a>
                </div>
								</div>
							</div>
							<div class="col-lg-3 d-none d-lg-block "></div>
