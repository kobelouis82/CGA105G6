...
<div>
	<a href="<%=request.getContextPath()%>/front-end/memLogin/login.jsp">
		<img src="http://localhost:8081/CGA105G6/front-end/product/3.png" class="d-block w-100 mx-auto headpic" alt="臥龍">
	</a>
</div>
		...
		<div class="row">
			<div class="col-md-4 col-xs-12">
				<div class="single-banner wow fadeIn" data-wow-duration=".5s"
					data-wow-delay=".5s">
					<a href="<%=request.getContextPath()%>/ForumArticleServlet?action=getOne_For_Display&articleNo=6"> <img src="http://localhost:8081/CGA105G6/front-end/product/8e3fe5cfc6f17a9e9796584b1f1kfpr5.jpg" alt="" /> <span>集結 LGBTQ+ 獨立創作者的遊戲同捆包開賣 以對抗《霍格華茲的傳承》</span>
					</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-12">
				<div class="single-banner wow fadeIn" data-wow-duration=".5s"
					data-wow-delay=".5s">
					<a href="<%=request.getContextPath()%>/ForumArticleServlet?action=getOne_For_Display&articleNo=7"> <img src="http://localhost:8081/CGA105G6/front-end/product/%E5%96%AC%E7%88%BE%E5%A4%AB%E7%90%83.jpg" alt="" /> <span>喬爾夫球"真的算是合理的報仇嗎?</span>
					</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-12">
				<div class="single-banner wow fadeIn" data-wow-duration=".5s"
					data-wow-delay=".5s">
					<a href="<%=request.getContextPath()%>/ForumArticleServlet?action=getOne_For_Display&articleNo=3"> <img src="http://localhost:8081/CGA105G6/front-end/product/ae70aca57304c77181feb3e65a1jy4b5.jpg" alt="" /> <span>《電馭叛客
