...
<ul>
<li><a href='<%=request.getContextPath() %>/back-end/supplier/listAllSupplier.jsp'>查詢所有廠商</a></li>
</ul>

<ul>
<li><a href='<%=request.getContextPath() %>/back-end/supplier/addSupplier.jsp'>新增採購廠商資料</a></li>
</ul>
